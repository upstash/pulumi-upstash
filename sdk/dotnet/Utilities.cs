...
namespace Upstash.Upstash
{
    static class Utilities
    {
        ...
        public static global::Pulumi.InvokeOptions WithDefaults(this global::Pulumi.InvokeOptions? src)
        {
            ...
            dst.PluginDownloadURL = src?.PluginDownloadURL ?? "https://github.com/upstash/upstash-pulumi-provider/releases/download/v${VERSION}";
            return dst;
        }
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Upstash.Upstash.version.txt");
    ...
    internal sealed class UpstashResourceTypeAttribute : Pulumi.ResourceTypeAttribute
    {
        public UpstashResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
